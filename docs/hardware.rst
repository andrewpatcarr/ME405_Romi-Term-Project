...
To help control each motor, we ran step input tests to find different characteristics of the motors.

Example Plots (Right Motor)
---------------------------

Position vs Time at different open loop step inputs

.. image:: _static/pos_time_right.png
   :width: 600px
   :alt: pos_time_right

Velocity vs Time at different open loop step inputs

.. image:: _static/velocity_time.png
   :width: 600px
   :alt: velocity_time

Steady-State Velocity vs Input Voltage

.. image:: _static/ss_inputvolt.png
   :width: 600px
   :alt: ss_inputvolt

Linearized Velocity vs Time (inverse of slope gives time constant)

.. image:: _static/linearized_time.png
   :width: 600px
   :alt: linearized_time
...
and phototransistor to detect reflectance of the surface it is pointed at. White surfaces return low readings,
while black surfaces return high readings. This sensor helps ROMI implement PID line following, adjusting motor
